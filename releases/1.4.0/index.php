<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	$pageTitle 		= "Nebula Release 1.4.0";
	...
	<div id="midcolumn">
		...
		<p>
		This is the Nebula <b>1.4.0</b> release. <a href="https://bugs.eclipse.org/bugs/buglist.cgi?order=component%2Cpriority%2Cbug_severity&product=Nebula&query_based_on=&query_format=advanced&target_milestone=1.4.0" target=blank>We resolved 26 issues in this release.</a>  
		</p>
		...
		<h3>Downloads</a></h3>
			<p style="font-weight: bold">
				<ul>
					...
					<li>Javadoc:  <a href="javadoc-1.4.0.zip">Javadoc (zip)</a></li>
				</ul>
			</p>	
	</div>
EOHTML;
