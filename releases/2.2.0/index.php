<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	$pageTitle 		= "Nebula Release 2.2.0";
	...
	<div class="col-md-24">
		...
		<br/>
		<p>
		This is the Nebula <b>2.2.0</b> release. <a href="https://bugs.eclipse.org/bugs/buglist.cgi?order=component%2Cpriority%2Cbug_severity&product=Nebula&query_based_on=&query_format=advanced&target_milestone=2.2.0" target=blank>Resolved Issues</a>  
		</p>
		...
		<h3>Downloads</a></h3>
			<p style="font-weight: bold">
				<ul>
					...
					<li>Javadoc:  <a href="javadoc-2.2.0.zip">Javadoc (zip)</a></li>
