		...
		<h3>Downloads</a></h3>
			<p style="font-weight: bold">
				<ul>
					...
					<li>Update site repo zipped: <a href="http://www.eclipse.org/downloads/download.php?file=nebula/releases/1.0.0/repository-nebula-1.0.0.zip">repository.zip</a></li>
				</ul>
			</p>
